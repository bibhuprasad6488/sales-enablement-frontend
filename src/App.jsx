...
const DetailsSlug = lazy(() => import("./home-sections/DetailsSlug"));
const WhoweAre = lazy(() => import("./home-sections/WhoweAre"));
const MeasurableGrowth = lazy(() => import("./service-section/MeasurableGrowth"));
const BookingConfirmation = lazy(() => import("./course-section/BookCoarseConfirmation"));
const Book_stepper = lazy(() => import("./course-Booking/Book_stepper"));
const SalesForceEvaluation = lazy(() =>
  import("./service-section/dedicated-pages/SalesForceEvolution")
);
  ...
  return (
    <BrowserRouter>
      ...
      <ContextProviders>
        ...
        {/* Tiny fallback so routing is instant */}
        <Suspense fallback={<div className="min-h-[40vh]"></div>}>
          ...
          <Routes>
            ...
            <Route path="/blog-details/:slug" element={<BlogDetails />} />
            <Route path="/contact-us" element={<ContactUsPage />} />
            <Route path="/services/sales-candidate-assessments/sample-sales-candidate-assessments"
              element={<SampleRequestPage />}
            />
            <Route path="/service/sales-force-details/:slug"
              element={<SalesForceEvaluation />}
            />
            <Route path="/service/sales-candidate-details/:slug"
              element={<CandidateAssessment />}
            />
            <Route path="/privacy-policy" element={<PrivacyPolicy />} />
            ...
            <Route path="/sales-enablement-that-drives-measurable-growth"
              element={<MeasurableGrowth />}
            />
            <Route path="*" element={<NotFound />} />
          </Routes>
